            ...
            <aside className="w-60 border-r border-foreground/10 flex flex-col shrink-0">
                ...
                <div className="p-3 space-y-2">
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors cursor-pointer">
                        <div className="size-7 rounded-full bg-linear-to-br from-primary to-primary/40 flex items-center justify-center">
                            <span className="text-primary-foreground font-semibold text-xs">MK</span>
                        </div>
                        <div className="flex-1 min-w-0">
                            <p className="text-xs font-medium text-white truncate">Musa Kamara</p>
                            <p className="text-xs text-foreground/60 truncate">@musa on zipa</p>
                        </div>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                <header className="h-16 border-b border-foreground/10 flex items-center justify-between px-6 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="size-8 rounded-full bg-linear-to-br from-primary to-primary/50 flex items-center justify-center cursor-pointer">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <div className="bg-foreground/2 border border-foreground/10 rounded-lg p-3 hover:border-primary/30 transition-colors cursor-pointer">
                                        <div className="flex flex-col items-center text-center">
                                            <div className="size-10 rounded-full bg-linear-to-br from-primary to-primary/50 flex items-center justify-center mb-2">
                                                <span className="text-primary-foreground font-semibold text-xs">AM</span>
                                            </div>
                                            <p className="text-xs font-semibold truncate w-full">Amaka M</p>
                                            <p className="text-xs text-foreground/60">Merchant</p>
                                        </div>
                                    </div>
                                    <div className="bg-foreground/2 border border-foreground/10 rounded-lg p-3 hover:border-primary/30 transition-colors cursor-pointer">
                                        <div className="flex flex-col items-center text-center">
