...
const badges = [
    { text: "@username payments", top: "15%", left: "5%" },
    { text: "SOL · ETH · Base", top: "25%", right: "8%" },
    { text: "Instant Zipa ledger", top: "60%", left: "10%" },
    { text: "NGN display", top: "70%", right: "18%" },
];
                        ...
                        <Balancer>
                            ...
                            {h1Line2.split(" ").map((word, index) => (
                                <motion.span
                                    ...
                                    className={cn(
                                        "inline-block",
                                        word === "message." && "bg-linear-to-r from-primary via-primary/80 to-primary bg-size-[200%_100%] animate-[shimmer_3s_ease-in-out_infinite] text-transparent bg-clip-text"
                                    )}
                                    key={index}
                                >
                                    {word}&nbsp;
