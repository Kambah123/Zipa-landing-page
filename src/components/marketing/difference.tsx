...
import { ZIPA_FEATURES, OTHER_TOOLS } from '@/constants/difference';
        ...
        <section id="difference" className="w-full py-16 lg:py-24 relative overflow-hidden">
            <Wrapper>
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        Crypto exchanges are built for traders. Zipa is built for people.
                    </motion.p>
                </div>
